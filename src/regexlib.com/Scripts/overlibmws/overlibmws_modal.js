/*
 overlibmws_modal.js plug-in module - Copyright Foteos Macrides 2006-2007. All rights reserved.
   ...
   Initial: November 15, 2006 - Last Revised: January 1, 2007
...
function OLmHideSB(){
for(var i=0;i<o3_frame.document.forms.length;i++){
for(var e=0;e<o3_frame.document.forms[i].length;e++){
if(o3_frame.document.forms[i].elements[e].tagName.toLowerCase()=="select"){
o3_frame.document.forms[i].elements[e].style.visibility="hidden";}}}
}
function OLmShowSB(){
for(var i=0;i<o3_frame.document.forms.length;i++){
for(var e=0;e<o3_frame.document.forms[i].length;e++){
if(o3_frame.document.forms[i].elements[e].tagName.toLowerCase()=="select"){
o3_frame.document.forms[i].elements[e].style.visibility="visible";}}}
}
